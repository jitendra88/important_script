...
def get_chat_data_from_v2(page):
    ...
    cur2.execute(
        "SELECT * FROM ofMessageArchive WHERE (fromJID ='12830@ip-172-31-42-152' OR  toJID='12830@ip-172-31-42-152') messageID NOT IN  (SELECT message_id from deleted_messages) ORDER BY messageID DESC limit " + str(
