...
def get_chat_data_from_v2(page):
    ...
    cur2.execute(
        "SELECT fromJID,toJID,sentDate,body,messageID FROM ofMessageArchive WHERE (fromJID='12830@ip-172-31-42-152' or toJID='12830@ip-172-31-42-152') AND  messageID NOT IN  (SELECT message_id from deleted_messages) ORDER BY messageID DESC limit " + str(
