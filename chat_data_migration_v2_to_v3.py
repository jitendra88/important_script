...
def get_chat_data_from_v2(page):
    ...
    cur2.execute(
        "SELECT fromJID,toJID,sentDate,body FROM ofMessageArchive WHERE  messageID NOT IN  (SELECT message_id from deleted_messages) ORDER BY messageID DESC limit " + str(
